...
async function importData() {
  ...
  const client = new Client({
    connectionString: 'postgresql://admin_accesorios:0mUP3q84JgJ1fMLFfc5s5EuhrUvPtBhV@dpg-d8j3tauq1p3s73fae98g-a.oregon-postgres.render.com/full_accesorios_db',
  ...
  await client.end();
  console.log('Import to Render completed successfully!');
}
